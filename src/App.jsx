    ...
    <div className="min-h-screen">
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-3xl mx-auto px-4 py-4">
          <Link to="/" className="text-2xl font-playfair text-primary">Christian Book Library</Link>
        </div>
      </header>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t">
        <div className="max-w-3xl mx-auto px-4 py-2 flex justify-between">
          ...
          <Link to="/favorites" className="flex flex-col items-center text-sm text-gray-600">
            <svg className="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="2" d="M4.318 6.318A4.5 4.5 0 0112 10.5 4.5 4.5 0 0119.682 6.318C20.88 7.516 21.5 9 21.5 10.5c0 3.866-3.582 7.25-9 11-5.418-3.75-9-7.134-9-11 0-1.5.62-2.984 1.818-4.182z"/></svg>
            Favorites
          </Link>
